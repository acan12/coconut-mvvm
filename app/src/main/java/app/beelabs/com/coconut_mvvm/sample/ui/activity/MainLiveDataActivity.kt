...
import app.beelabs.com.coconut_mvvm.sample.databinding.ActivityMainLiveBinding
...
@AndroidEntryPoint
class MainLiveDataActivity : BaseActivity(), IMainView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMainLiveBinding.inflate(layoutInflater)
